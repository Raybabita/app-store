...
class AppStore extends Component {
  ...
  getFilterApp = () => {
    ...
    const filterAppDetails = appsList.filter(
  ...
  render() {
    ...
    const filterAppDetails = this.getFilterApp()

    const inputSearchFilters = filterAppDetails.filter(eachAppItem =>
      ...
      <div className="app-container">
        <div className="app-store">
          ...
          <ul className="app-list">
            {inputSearchFilters.map(eachApp => (
